...
Dado("que esteja no CAR com áreas a recompor") do
    ...
    InsereDados.inicio(nomeCAR = "ADEQ GW Fazenda " +  Faker::Name.first_name,  muni = "ALTAIR")
...
Quando("finalizar o CAR") do
    ...
    puts("CAR com Adequacao criado com sucesso no ambiente " + link + " e seu número é: " +  @numCarPrada)
end
  
Quando("preencher todos os campos da adequação ambiental") do
